...
public class GuildMessageViewRow(string connectionString, HandlersGroup handlersGroup, IDataRecord reader) : BaseViewRow(connectionString, handlersGroup, reader)
{
    /// <summary>
    ///     Guild id.
    /// </summary>
